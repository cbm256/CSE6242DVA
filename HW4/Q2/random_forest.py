...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
        ...
        # Create sample dataset with replacement
    ...
    def fitting(self):
        ...
        for i in range(self.num_trees):
            print("Begin Building Tree " + str(i))
            # Create decision trees for each bootstrap
    ...
    def voting(self, X):
        ...
        for record in X:
            ...
            for i in range(len(self.bootstraps_datasets)):
                ...
                # For the record as an out-of-bag sample, find predicted y
            ...
            if len(counts) == 0:
                ...
                y.append(self.bootstraps_labels[0][index])
            else:
